...
?>
    ...
    <body>
        ...
        <div class="br-mainpanel">
            ...
            <div class="br-pagebody row">
                <div class="br-section-wrapper container">
                    ...
                    <br>
                        <table id="color_data" class="table-responsive table table-active table-check table table-striped text text-center">
                            <thead>
                                <tr>
                                    <th class="wd-5p text text-center">Id</th>
                                    <th class="wd-20p text text-center">Descripcion</th>
                                    <th class="wd-15p text text-center">Estado</th>
        ...
        require_once("AdminColorModal.php");


        ?>
        <script type="text/javascript" src="adminColor.js"></script>
    </body>
