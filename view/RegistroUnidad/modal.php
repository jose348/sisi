    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 id ="lbltitulo" class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Nueva Marca</h6>
            ...
            <div class="modal-body">
                <form method="post" id="categoria_form" class="form row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Codigo de Unidad: <span class="tx-danger">*</span></label>
                            <input class="form-control tx-uppercase" id="" type="date" name="" required />
                        </div>
                    </div>
