...
?>
    ...
    <body>
        ...
        <div class="br-mainpanel">
            ...
            <div class="br-pagebody row">
                <div class="br-section-wrapper container">
                    ...
                    <br>
                    <button class="col-lg-3 btn btn-outline-primary float-right" id="add_button" onclick="nuevaMarca()">
                        ...
                        <table id="marca_data" class="table-responsive table table-active table-check table table-striped text text-center  ">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-20p text text-center">Marca</th>
        ...
        require_once("adminMarcaModal.php");


        ?>

        <script type="text/javascript" src="adminMarca.js"></script>
