        ...
        <div class="br-mainpanel">
            ...
            <div class="br-pagebody row">
                <div class="br-section-wrapper container">
                    ...
                    <br>
                        <table id="modelo_data" class="table-responsive table table-active table-check table table-striped text text-center">
                            <thead>
                                <tr>
                                    <th class="wd-5p text text-center">Id</th>
                                    <th class="wd-5p text text-center">Descripcion</th>
                                    <th class="wd-20p text text-center">Estado</th>
                                    <th class="wd-15p text text-center">Marca</th>
