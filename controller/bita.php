...
switch ($_GET["op"]) {
    ...
    case "combo_marca_busquedad":
        ...
        case "listar_bitacora":
            ...
            $placaUnidad = isset($_POST["placaUnidad"]) ? $_POST["placaUnidad"] : ""; // Capturamos placaUnidad
            $fechaDesde = isset($_POST["fechaDesde"]) ? $_POST["fechaDesde"] : "";    // Capturamos la fecha desde
            $fechaHasta = isset($_POST["fechaHasta"]) ? $_POST["fechaHasta"] : "";    // Capturamos la fecha hasta
        
            // Llamamos al método del modelo con los parámetros de filtro
            $datos = $bita->get_lista_bitacora($tiun_id, $mode_id, $marc_id, $placaUnidad, $fechaDesde, $fechaHasta);
    ...
    case "get_historial_unidad":
        ...
        // Caso para generar PDF
case "generar_reporte_pdf":
    $tiun_id = isset($_GET["tiun_id"]) ? $_GET["tiun_id"] : "";
    $mode_id = isset($_GET["mode_id"]) ? $_GET["mode_id"] : "";
    $marc_id = isset($_GET["marc_id"]) ? $_GET["marc_id"] : "";
    $placaUnidad = isset($_GET["placaUnidad"]) ? $_GET["placaUnidad"] : "";
    ...
    // Generar el PDF
    $bita->generarPDF($datos);
    break;

// Caso para generar Excel
