...
switch ($_GET["op"]) {
    ...
    case "guardaryeditarArea":
        if (empty($_POST["depe_id"])) {
            $area->insert_area(strtoupper($_POST["depe_codigo"]), strtoupper($_POST["depe_denominacion"]), strtoupper($_POST["depe_abreviatura"]), strtoupper($_POST["depe_siglasdoc"]), strtoupper($_POST["depe_representante"]), strtoupper($_POST["depe_cargo"]),strtoupper($_POST["depe_direccion"]), strtoupper($_POST["depe_telefono"]), strtoupper($_POST["depe_anexo"]), strtoupper($_POST["depe_codrof"]), $_POST["depe_superior"], strtoupper($_POST["nior_id"]), strtoupper($_POST["tpor_id"]), strtoupper($_POST["tpde_id"]), strtoupper($_POST["lomu_id"]));
        } else {
